...
function renderView(webGLContext, viewProgram, element, top, left, colorLocation, positionLocation, parentLeft, parentWidth) {
  if (isViewVisible(element)) {
    ...
    webGLContext.uniform1f(webGLContext.getUniformLocation(viewProgram, 'u_parentWidth'), parentLeft + parentWidth);
