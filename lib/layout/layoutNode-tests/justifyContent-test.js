...
describe('justifyContent', function() {
  ...
  it ('should align justifyContent: flex-start (column)', function() {
    ...
    testStructure(View({}, {flexDirection: 'column', justifyContent: 'flex-start'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: flex-end (column)', function() {
    var sharedStyle = {width: Math.floor(100 * Math.random()), height: Math.floor(100 * Math.random())};
    testStructure(View({}, {flexDirection: 'column', justifyContent: 'flex-end'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: center (column)', function() {
    ...
    testStructure(View({}, {flexDirection: 'column', justifyContent: 'center'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: space-between (column)', function() {
    ...
    testStructure(View({}, {flexDirection: 'column', height: 1000, justifyContent: 'space-between'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: space-between (row)', function() {
    ...
    testStructure(View({}, {flexDirection: 'row', justifyContent: 'space-between'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: space-around (column)', function() {
    ...
    testStructure(View({}, {flexDirection: 'column', height: 1000, justifyContent: 'space-around'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
  ...
  it ('should align justifyContent: space-around (row)', function() {
    ...
    testStructure(View({}, {flexDirection: 'row', justifyContent: 'space-around'}, [
      View({}, sharedStyle, []),
      View({}, sharedStyle, []),
      View({}, sharedStyle, [])
    ]));
